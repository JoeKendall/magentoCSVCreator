"<?php echo $displayProduct['sku']; ?>",,Default,simple,,,base,,,,"2013-07-25 13:26:49",,,,,"<?php echo str_replace('"', '""', $displayProduct['title']); ?>",1,,,0,no_selection,,,,,,,,,"Use config","Use config","<?php echo str_replace('"', '""', $displayProduct['title']); ?>",,,"Block after Info Column",,<?php echo $getPrices['1']; unset($getPrices['1']);?>,0,"<?php echo str_replace('"', '""', $displayProduct['title']); ?>",no_selection,,,,,1,5,no_selection,,"2013-07-31 14:17:50","<?php echo createUrl($displayProduct['title']); ?>","<?php echo createUrl($displayProduct['title']); ?>.html",1,99.0000,1000.0000,0.0000,1,0,0,1,1.0000,1,0.0000,1,1,,1,0,1,0,1,0.0000,1,0,0,,,,,,,,,,<?php
